import 'package:coding_test/ui/widgets/screens/main_page.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'Coding Test Home Page'),
    );
  }
}
        ...
        child: Column(
          ...
          children: <Widget>[
            FlatButton(
              ...
              color: Colors.red,colorBrightness: Brightness.light,
              child: Text(
